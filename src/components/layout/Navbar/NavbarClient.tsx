...
export default function NavbarClient({
  ...
  }, [mobileMenuOpen]); // Removed isDrawerVisible from dep array to avoid loops
    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* PERBAIKAN: Hapus z-[70]. Biarkan tombol ini tertutup saat menu drawer muncul.
                  Tombol ini hanya untuk MEMBUKA. 
               */}
          <button
      ...
      {isDrawerVisible && (
        <>
          ...
          <div
            className={cn(
              "fixed inset-0 z-[60] bg-black/60 lg:hidden transition-opacity duration-300 ease-in-out", // Z-index 60 agar di atas navbar (z-50)
              isClosing
          ...
          <aside
            className={cn(
              "fixed top-0 right-0 h-screen w-[85%] max-w-[320px] bg-[#005320] shadow-2xl z-[70] flex flex-col lg:hidden ", // Z-index 70 agar di atas backdrop
