...
export default function CurriculumSection({ data }: CurriculumSectionProps) {
   ...
   return (
      <section className="w-full bg-gray-50/50 py-16 md:py-24">
         ...
         {/* 3. <div> baru di dalam untuk 'container': membatasi konten agar tetap di tengah */}
                  ...
                  return (
                     ...
                     >
                        ...
                        <button
                           ...
                           className={cn(
                              "w-full flex items-center justify-between p-5 md:p-6 text-left transition-colors duration-300 relative z-10",
                           ...
                           <div className="flex flex-col border-t border-gray-100">
                              {semester.courses.length > 0 ? (
                                 ...
                                 <div className="p-8 text-center bg-gray-50/50">
                                    <div className="text-gray-400 italic text-sm py-4 border-2 border-dashed border-gray-200 rounded-lg">
