...
export default function WelcomeSection({ data }: WelcomeSectionProps) {
   // Defensive Check: Jika data kosong, jangan render apapun
         ...
         <div className="container mx-auto px-4 space-y-20 md:space-y-32">
            ...
            {data.map((profile, index) => {
               ...
               return (
                  <div
                     key={profile.id}
                     // PERBAIKAN: Menambahkan 'justify-center' agar saat di desktop terlihat seimbang
                  ...
                  >
                     ...
                     {/* --- BAGIAN TEKS --- */}
                     {/* PERBAIKAN: Mengubah flex-1 menjadi md:w-7/12 agar lebih proporsional dengan gambar baru */}
                     ...
                     {/* --- BAGIAN GAMBAR (YANG DIKECILKAN) --- */}
                     {/* PERBAIKAN UKURAN:
                                - Mobile: w-9/12 (75% lebar) dan mx-auto (tengah)
                                - Desktop: md:w-4/12 (1/3 lebar, lebih kecil dari sebelumnya 5/12) dan md:mx-0 (reset tengah)
                            */}
